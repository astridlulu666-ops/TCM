...
//        将关联药材装入ArrayList
        ...
        // 从 Session 中获取参数，如果不存在则返回错误信息
        Object supportObj = req.getSession().getAttribute("Support");
        Object confidenceObj = req.getSession().getAttribute("Confidence");
        Object medicineStrAprioriObj = req.getSession().getAttribute("medicineStr");
        
        if (supportObj == null || confidenceObj == null || medicineStrAprioriObj == null) {
        ...
        support = (int) supportObj;
        confidence = (double) confidenceObj;
        medicineStrApriori= (ArrayList<String>) medicineStrAprioriObj;
