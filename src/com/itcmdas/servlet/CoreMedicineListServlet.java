...
public class CoreMedicineListServlet extends BasicServlet {
    ...
    public void saveDataToSession(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        String minMedicineNumStr = req.getParameter("minMedicineNum");
        String maxMedicineNumStr = req.getParameter("maxMedicineNum");
        
        // 检查参数是否为空
        if(medicineStrCoreMedicine == null || minMedicineNumStr == null || maxMedicineNumStr == null) {
        ...
        // 转换参数类型
        try {
            minMedicineNum = Integer.parseInt(minMedicineNumStr);
            maxMedicineNum = Integer.parseInt(maxMedicineNumStr);
    ...
    public void coreMedicineListsData(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        //获取session中的数据
        Object medicineStrCoreMedicineObj = req.getSession().getAttribute("medicineStr");
        Object minMedicineNumObj = req.getSession().getAttribute("minMedicineNum");
        Object maxMedicineNumObj = req.getSession().getAttribute("maxMedicineNum");
        
        if (medicineStrCoreMedicineObj == null || minMedicineNumObj == null || maxMedicineNumObj == null) {
            JSONObject obj = new JSONObject();
            obj.put("code", 1);
        ...
        medicineStrCoreMedicine = (String[]) medicineStrCoreMedicineObj;
        minMedicineNum = (int) minMedicineNumObj;
        maxMedicineNum = (int) maxMedicineNumObj;
